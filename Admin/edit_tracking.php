...
?>
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <div class="form-group">
                                    <label>Location Logitude on map</label>
                                    <input type="text" name="lon" class="form-control" placeholder="-74.00597">
                                </div>
                                <div class="form-group">
                                    <label>Location Latitude on map</label>
                                    <input type="text" name="lat" class="form-control" placeholder="40.71427">
                                </div>
                                <div class="checkbox">
                                    <label>
