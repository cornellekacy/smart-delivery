        ...
        <div class="footer-widgets widgets-area">
            ...
            <div class="footer-sidebars">
                <div class="container">
                        ...
                        <div class="footer-sidebar footer-1 col-xs-12 col-sm-6 col-md-3">
                            <div class="widget widget_text">
                                ...
                                <div class="textwidget">
                                    <p>CONTINENTAL shipper Logistics Services is a global supplier of transport and logistics solutions. We have offices in more than 20 countries and an international network of partners and agents.</p>
                                </div>
                            </div>
                    ...
                    <li><a href="qoute.php">Qoute</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-copyright col-md-6 col-sm-12 col-sx-12">
                        <div class="site-info">Copyright @ 2018 <a href="continentalshipper.com">Continental Shipper</a>, All Right Reserved </div>
                    </div>
                </div>
            </div>
        </footer>
    ...
    <div class="primary-mobile-nav header-v1" id="primary-mobile-nav" role="navigation">
        ...
        <li class="extra-menu-item menu-item-button-link">
            <a href="qoute.php" class="fh-btn btn">Get A Quote</a>
        </li>
        </ul>
    ...
    <div class="demo_changer" id="demo_changer">
        ...
        <div class="form_holder">
            ...
            <div class="predefined_styles" id="styleswitch_area">
                <a href="indexc392.html?default=true" data-rel="default" class="styleswitch" style="background:#ff0000;border-right-color: #0c1239;border-bottom-color: #0c1239"></a>
    ...
    <script src="bs-modal-fullscreen.min.js"></script>
...
<!-- Mirrored from steelthemes.com/demo/html/cargohub_theme/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Aug 2018 05:12:44 GMT -->
</html>